...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    private void initListener() {
        ...
        EaseUserUtils.setCurrentAppUserNameWithNo(tvProfileWeixinhao);
    }
            ...
            public void onSuccess(EaseUser user) {
                if (user != null) {
                    ...
                    if (!TextUtils.isEmpty(user.getAvatar())) {
                        Glide.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.drawable.default_hd_avatar).into(ivProfileAvatar);
                    } else {
                        Glide.with(UserProfileActivity.this).load(R.drawable.default_hd_avatar).into(ivProfileAvatar);
                    }
                }
            }
                        ...
                        .setPositiveButton(R.string.dl_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (nickString.equals(user.getMUserNick())){
                                    CommonUtils.showLongToast(R.string.toast_nick_not_modify);
                                    return;
                                }
